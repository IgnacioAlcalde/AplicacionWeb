...
import DirectorMunicipalidad from "./paginas/Dashboards/director_municipalidad.jsx";
...
import DirectorObra from "./paginas/Dashboards/director_obras.jsx";
...
import GestorTerritorial from "./paginas/Dashboards/gestor_territorial.jsx";
...
import Cuadrilla from "./paginas/Dashboards/cuadrilla.jsx";
      ...
      <Router>
        <Routes>
          ...
          >
            ...
            <Route  path="tareas-incidencias/:_id" element={<TareasIncidencias />}/>
          ...
          <Route path='cuadrilla' element={<Cuadrilla/>}>
              ...
              <Route path='generar-ticket' element={<GenerarTIcket/>}/>
              <Route path='incidencias' element={<VerIncidencias/>}/>
            </Route>
        </Routes>
      </Router>
    </div>
