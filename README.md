...
si es primera vez que lo corres es necesario usar el comando "npm install"(mientras estas en la carpeta aplicacion), despues instalar lo sgte "npm install react-router-dom react-hot-toast react-hook-form react-icons axios bootstrap"
